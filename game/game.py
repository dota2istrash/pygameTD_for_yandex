...
class Game:
    ...
    def initialize_media(self):
        ...
        # Setup game Clock
        self.clock_font = pg.font.Font(None, 50)
        self.clock_font.set_bold(True)
        ...
        self.coin_font = pg.font.Font(None, 50)
        self.coin_font.set_bold(True)
        ...
        self.lifes_font = pg.font.Font(None, 50)
        self.lifes_font.set_bold(True)
        ...
        self.skip_font = pg.font.Font(None, 35)
